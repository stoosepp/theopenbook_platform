...
function tt_render_list_page(){
    ...
    <div class="wrap">
        ...
        <h2>List Table Test <a href="#" class="page-title-action">Add Thing Button</a> <a href="#" class="page-title-action">Add Thing 2 Button</a></h2>
    ...
    <?php
    //Create an instance of our package class...
    $testListTable2 = new TT_Example_List_Table();
    //Fetch, prepare, sort, and filter our data...
